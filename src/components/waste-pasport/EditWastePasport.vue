      ...
      <div class="col">
            ...
            <ValidationObserver v-slot="{handleSubmit}">
              <form @submit.prevent="handleSubmit(onSubmit)">
                <div class="form-group">
                  <ValidationProvider name="select-waste-pasport" rules="nullInput" v-slot="{errors,classes}" >
                    <label>Выберите отход</label>
                    <select ref="select" v-model="current" class="custom-select form-control-custom" :class="classes">
        ...
        <!--                class="helper-text invalid">{{'Message_CategoryTitle'|localize}}</span>-->
                ...
                <div class="from-group">
                  <ValidationProvider name="waste-code" rules="nullInput" v-slot="{errors,classes}" >
                    <label for="waste-code">Код отхода</label>
                    <input id="waste-code" type="text" v-model="wasteCode" class="form-control" :class="classes" />
                    <span class="null_error">{{ errors[0] }}</span>
                  </ValidationProvider>
                </div>
                ...
                <div class="input-field">
                  ...
                  <table class="table">
                    ...
                    <tr class="item" v-for="(waste, index) in wastesOrigin" :key="index">
                      <td>
                        <ValidationProvider name="1-proi-waste-passport" rules="nullInput" v-slot="{errors,classes}" >
                          <input type="text" class="form-control" v-model="waste.wasteSource"    :class="classes" />
                          <span class="null_error">{{ errors[0] }}</span>
                        </ValidationProvider>
                      </td>
                      <td>
                        <ValidationProvider name="2-proi-waste-passport" rules="nullInput" v-slot="{errors,classes}" >
                         <input type="text" class="form-control" v-model="waste.processName"  :class="classes"/>
                          <span class="null_error">{{ errors[0] }}</span>
                        </ValidationProvider>
                      </td>
                      <td>
                        <ValidationProvider name="3-proi-waste-passport" rules="nullInput" v-slot="{errors,classes}" >
                          <input type="text" class="form-control" v-model="waste.hazardProperty" :class="classes" />
                          <span class="null_error">{{ errors[0] }}</span>
                        </ValidationProvider>
                      </td>
                      <td class="text-right">
                ...
                <div class="input-field table-responsive">
                  ...
                  <table class="table">
                    ...
                    <tr class="item" v-for="(w, idx) in wastesComposition" :key="idx">
                      <td>
                        <ValidationProvider name="1-chim-waste-passport" rules="nullInput" v-slot="{errors,classes}" >
                          <input type="text" class="form-control" v-model="w.wasteComponentName" :class="classes"/>
                          <span class="null_error">{{ errors[0] }}</span>
                        </ValidationProvider>
                      </td>
                      <td>
                        <ValidationProvider name="2-chim-waste-passport" rules="nullInput" v-slot="{errors,classes}" >
                          <input type="number" class="form-control" v-model.number="w.wasteComponentConcentration" :class="classes" />
                          <span class="null_error">{{ errors[0] }}</span>
                        </ValidationProvider>
                      </td>
                      <td>
                        <ValidationProvider name="3-chim-waste-passport" rules="nullInput" v-slot="{errors,classes}" >
                          <input type="text" class="form-control" v-model="w.wasteIndexSourceName" :class="classes" />
                          <span class="null_error">{{ errors[0] }}</span>
                        </ValidationProvider>
                      </td>
                      <td>
                        <ValidationProvider name="4-chim-waste-passport" rules="nullInput" v-slot="{errors,classes}" >
                          <input type="text" class="form-control" v-model="w.wasteIndexSourceValue" :class="classes"/>
                          <span class="null_error">{{ errors[0] }}</span>
                        </ValidationProvider>

                      </td>
                      <td>
                        <ValidationProvider name="5-chim-waste-passport" rules="nullInput" v-slot="{errors,classes}" >
                          <select v-model="w.hazWasteLevel" class="custom-select browser-default" :class="classes">
                      ...
                      <td>
                        <ValidationProvider name="6-chim-waste-passport" rules="nullInput" v-slot="{errors,classes}" >
                          <input type="number" class="form-control" v-model.number="w.hazWasteLevelValue" :class="classes" />
                          <span class="null_error">{{ errors[0] }}</span>
                        </ValidationProvider>
                      </td>
                      <td>
                        <ValidationProvider name="7-chim-waste-passport" rules="nullInput" v-slot="{errors,classes}" >
                          <input type="text" class="form-control" v-model="w.wasteIndexSourceDocument" :class="classes"/>
                          <span class="null_error">{{ errors[0] }}</span>
                        </ValidationProvider>
                      </td>
                      <td class="text-right">
                ...
                <div class="form-group">
                  <ValidationProvider name="recycling-type" rules="nullInput" v-slot="{errors,classes}" >
                    <label for="recycling-type">Рекомендуемый способ переработки отходов</label>
                    <textarea id="recycling-type"
                              type="text"
        ...
        <!--                class="helper-text invalid">{{'Message_Recycling_Type_Title'|localize}}</span>-->
                ...
                <div class="form-group">
                  <ValidationProvider name="precaution-type" rules="nullInput" v-slot="{errors,classes}" >
                    <label for="precaution-type">Необходимые меры предосторожности при обращении с отходами</label>
                    <textarea id="precaution-type"
                              type="textarea"
                              v-model="precaution"
                              class="form-control form-control-textarea"
                              :class="classes"
        ...
        <!--                class="helper-text invalid">{{'Message_Precaution_Title'|localize}}</span>-->
                ...
                работ-->
                <div class="form-group">
                  <ValidationProvider name="transportation-requirements" rules="nullInput" v-slot="{errors,classes}" >
                    <label for="transportation-requirements">Требование к транспортировке отходов и проведение погрузо-разгрузочных
                      работ</label>
                    <textarea id="transportation-requirements"
                              type="textarea"
                ...
                <div class="form-group">
                  <ValidationProvider name="emergency-requirements" rules="nullInput" v-slot="{errors,classes}" >
                    ...
                    <textarea id="emergency-requirements"
                              type="textarea"
                              v-model="emergency"
                              class="form-control form-control-textarea"
                              :class="classes"
                ...
                <div class="form-group">
                  <ValidationProvider name="additional-info" rules="nullInput" v-slot="{errors,classes}" >
        ...
        <!--                class="helper-text invalid">{{'Message_Waste_Type_Title'|localize}}</span>-->
                ...
                <div class="form-group">
                  <ValidationProvider name="waste-types" rules="nullInput" v-slot="{errors,classes}" >
                    <label for="waste-types">Вид отходов</label>
                    <select v-model="wasteColor.wasteType"
                            v-if="wasteColor.color"
                ...
                <div class="form-group">
                  <ValidationProvider name="waste-index" rules="nullInput" v-slot="{errors,classes}" >
                    <label for="waste-index">Индекс отхода</label>
                    <input id="waste-index"
                           type="text"
                           v-model="wasteIndex"
                           class="form-control"
                           :class="classes"
                ...
                <div class="form-group">
                  <ValidationProvider name="limit" rules="nullInput" v-slot="{errors,classes}" >
        ...
        <!--                class="helper-text invalid">{{'Message_MinLength'|localize}} {{$v.limit.$params.minValue.min}}</span>-->
                ...
                <div class="form-group">
                  <ValidationProvider name="limit-kzt" rules="nullInput" v-slot="{errors,classes}" >
                    <label for="limit-kzt">Лимит KZT</label>
                    <input id="limit-kzt" type="number"
